...
public class ICD10Importer implements TTImport {
    ...
    private final  org.endeavourhealth.imports.sources.ImportMaps importMaps = new  org.endeavourhealth.imports.sources.ImportMaps();
    ...
    public void importMaps(String folder) throws IOException, DataFormatException {
        ...
        Path file =  ImportUtils.findFileForId(folder,maps[0]);
         org.endeavourhealth.imports.sources.ComplexMapImporter mapImport= new  org.endeavourhealth.imports.sources.ComplexMapImporter();
