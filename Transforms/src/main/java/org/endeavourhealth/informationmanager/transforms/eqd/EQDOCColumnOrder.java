...
public class EQDOCColumnOrder {
    ...
    protected List<EQDOCColumnOrder.Columns> columns;
     ...
     * {@link EQDOCColumnOrder.Columns }
     * 
     * 
     */
    public List<EQDOCColumnOrder.Columns> getColumns() {
        if (columns == null) {
            columns = new ArrayList<EQDOCColumnOrder.Columns>();
        }
        return this.columns;
    }
