...
public class EQDOCKeyValuePair {
    ...
    @XmlElement(required = true)
    protected List<EQDOCKeyValuePair.Value> value;
     ...
     * @return
     *     possible object is
     *     {@link EQDOCKeyValuePair.Key }
     *     
     */
    public EQDOCKeyValuePair.Key getKey() {
        return key;
    }
     ...
     *     
     */
    public void setKey(EQDOCKeyValuePair.Key value) {
        this.key = value;
    }
     ...
     * {@link EQDOCKeyValuePair.Value }
     * 
     * 
     */
    public List<EQDOCKeyValuePair.Value> getValue() {
        if (value == null) {
            value = new ArrayList<EQDOCKeyValuePair.Value>();
        }
        return this.value;
    }
